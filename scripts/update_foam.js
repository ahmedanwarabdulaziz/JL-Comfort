...
const filePath = path.join(__dirname, '..', 'app', 'foam', 'FoamPageClient.tsx');
...
const newReturn = `  return (
    <Box sx={{ minHeight: '100vh', bgcolor: '#fafafa' }}>
      <AppBar position="sticky" sx={{ bgcolor: '#000000', color: '#ffffff' }}>
        <Toolbar>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1, fontWeight: 'bold', letterSpacing: 2 }}>
            <span style={{ color: '#e3c29a' }}>JL</span> COMFORT
          </Typography>
          <Button color="inherit" component={Link} href="/" sx={{ '&:hover': { color: '#e3c29a' }}}>
            Home
          </Button>
          <Button color="inherit" component={Link} href="/admin" sx={{ '&:hover': { color: '#e3c29a' }}}>
            Admin
          </Button>
        </Toolbar>
      </AppBar>
      ...
      <Box sx={{ bgcolor: '#e3c29a', color: '#000', py: { xs: 4, md: 6 }, px: 2, textAlign: 'center' }}>
        ...
        <Typography variant="h6" sx={{ maxWidth: 600, mx: 'auto', fontWeight: 'normal', opacity: 0.9 }}>
          Design your perfect cushion in 3 easy steps. Select a shape, enter your dimensions, and choose your premium foam grade.
        </Typography>
      </Box>
                ...
                <Paper elevation={0} sx={{ p: { xs: 3, md: 5 }, borderRadius: 4, border: '1px solid', borderColor: 'divider', mb: 4 }}>
                  <Grid container spacing={6}>
                    ...
                    <Grid item xs={12} md={7}>
                      ...
                      <Typography variant="h6" sx={{ fontWeight: 'bold', mb: 2 }}>Select Foam Grade</Typography>
                      {foamGrades.length === 0 ? (
                                  ...
                                  <Box sx={{ mt: 2, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 1 }}>
                                    ...
                                    {grade.warranty && (
                                      <Box sx={{ gridColumn: 'span 2' }}>
                                        <Typography variant="caption" color="text.secondary" display="block">Warranty</Typography>
